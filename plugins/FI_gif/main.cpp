...
extern "C" 
{
	...
	KK_API int KK_C_DECL kkPluginGetPluginInfo( kkPluginInfo* out_info )
	{
		...
		out_info->m_extensions        = u"gif";
		out_info->m_extension_description   
									  = u"GIF";
		out_info->m_full_description  = u"Plugin for import .gif files.";
		out_info->m_short_description = u"GIF loader.";
		out_info->m_name              = u"GIF import plugin.";
