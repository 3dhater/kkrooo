...
extern "C" 
{
	...
	KK_API int KK_C_DECL kkPluginGetPluginInfo( kkPluginInfo* out_info )
	{
		...
		out_info->m_extensions        = u"bmp";
		out_info->m_extension_description   
									  = u"BMP";
		out_info->m_full_description  = u"Plugin for import .bmp files.";
		out_info->m_short_description = u"BMP loader.";
		out_info->m_name              = u"BMP import plugin.";
