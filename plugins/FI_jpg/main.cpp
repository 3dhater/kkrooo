...
extern "C" 
{
	...
	KK_API int KK_C_DECL kkPluginGetPluginInfo( kkPluginInfo* out_info )
	{
		...
		out_info->m_extensions        = u"jpg jpeg jfif jpe exif";
		out_info->m_extension_description   
									  = u"JPEG";
		out_info->m_full_description  = u"Plugin for import .jpg files.";
		out_info->m_short_description = u"JPEG loader.";
		out_info->m_name              = u"JPEG import plugin.";
