...
extern "C" 
{
	...
	KK_API int KK_C_DECL kkPluginGetPluginInfo( kkPluginInfo* out_info )
	{
		...
		out_info->m_extensions        = u"tga";
		out_info->m_extension_description   
									  = u"TGA";
		out_info->m_full_description  = u"Plugin for import .tga files.";
		out_info->m_short_description = u"TGA loader.";
		out_info->m_name              = u"TGA import plugin.";
