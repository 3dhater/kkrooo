...
extern "C" 
{
	...
	KK_API int KK_C_DECL kkPluginGetPluginInfo( kkPluginInfo* out_info )
	{
		...
		out_info->m_extensions        = u"tiff tif";
		out_info->m_extension_description   
									  = u"TIFF";
		out_info->m_full_description  = u"Plugin for import .tiff files.";
		out_info->m_short_description = u"TIFF loader.";
		out_info->m_name              = u"TIFF import plugin.";
