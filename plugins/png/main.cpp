...
extern "C" 
{
	...
	KK_API int KK_C_DECL kkPluginGetPluginInfo( kkPluginInfo* out_info )
	{
		...
		out_info->m_extensions        = u"png";
		out_info->m_extension_description   
									  = u"Portable Network Graphics";
		out_info->m_full_description  = u"Plugin for import .png files.";
		out_info->m_short_description = u"PNG loader.";
		out_info->m_name              = u"PNG import plugin.";
