...
public:
	...
	kkPluginGUIWindowElement* AddValueSelectorFloatLimit( f32 minim, f32 maxim, f32 * ptr, f32 speed, bool horizontal, const v2f& size, kkPluginGUICallback cb, kkPluginGUIParameterType pt);
