...
void kkGSDrawModel(kkMesh*,const kkMatrix4&, const kkColor& difCol, kkImageContainerNode* m_diffTex, bool isSelected);
void kkGSDrawModelSilhouette(kkMesh*,const kkMatrix4&, const kkColor& difCol);
...
void kkDrawAll();
void kkSetAppStateMain(AppState_main);
AppState_main kkGetAppStateMain();
void kkGSSetScissor(bool, const v4i&);
...
void kkSetActiveViewport(ViewportObject*);
